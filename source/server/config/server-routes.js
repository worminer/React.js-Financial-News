...
module.exports = (app) => {
  ...
  app.get('/api/movies/:movieId/comments',
    controllers.comment.getMovieComments.get)
  app.post('/api/movies/:movieId/comments',
    controllers.comment.getMovieComments.post)
